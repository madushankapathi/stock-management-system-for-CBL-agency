 ...
 * @author Madushanka
 */
public class balance_report extends javax.swing.JFrame {
    ...
    public balance_report(TableModel a) {
        initComponents();
         TableModel model = a;
        String report = "/reports/Balance_A4.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(balance_report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new balance_report().setVisible(true);
            }
        });
    }
