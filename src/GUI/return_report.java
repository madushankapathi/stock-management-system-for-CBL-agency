 ...
 * @author Madushanka
 */
public class return_report extends javax.swing.JFrame {
    ...
    public return_report(TableModel a,String b) {
        initComponents();
         TableModel model = a;
         String amu = b;
        String report = "/reports/return_A4.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(return_report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new return_report().setVisible(true);
            }
        });
    }
